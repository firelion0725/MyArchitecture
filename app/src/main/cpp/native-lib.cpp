...
//Java_com_leo_architecture_test_ndk_TestNdk_showToast(JNIEnv *env, jclass clazz, jstring string) {
//    jclass jclz = (*env).FindClass("android/widget/Toast");
//    jmethodID makeText = (*env).GetStaticMethodID(jclz, "makeText",
//                                            "(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;");
//
//    jobject toast = env->CallStaticObjectMethod(jclz,makeText,)
//}
extern "C"
JNIEXPORT void JNICALL
Java_com_leo_architecture_test_ndk_TestNdk_showToast(JNIEnv *env, jclass clazz, jobject context,
                                                     jstring string) {
    jclass jclz = (*env).FindClass("android/widget/Toast");
    jmethodID makeText = (*env).GetStaticMethodID(jclz, "makeText",
                                                  "(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;");
